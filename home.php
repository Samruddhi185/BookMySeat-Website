...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <a href="home_faq.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="home_faq.php" class="w3-bar-item w3-button" style="width:25% !important">FAQs</a>
...
<div class="w3-padding-large" id="main">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p>#1 exclusive for seat exchange.</p>
<p>Meet all your local seat exchange needs in one place.</p>
<p>Now no need of constant bickering with others to find a seat at rush-hour.</p>
<p>Earn reward points and get exciting offers.</p>
<p>Just one click away.</p>
<p>We wish you a pleasant and happy experience !
    </p>
