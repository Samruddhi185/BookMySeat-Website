...
--
-- Host: localhost
-- Generation Time: Apr 08, 2018 at 04:51 PM
...
INSERT INTO `train_1001` (`user_id`, `train_id`, `station_id`, `leave_time`, `compartment`, `seat_avail`, `profile_pic`) VALUES
(5, 1001, 12, '08:20:00', 1, 2, ''),
(4, 1001, 14, '08:30:00', 1, 2, ''),
(3, 1001, 14, '10:00:00', 2, 11, ''),
(1, 1001, 11, '10:00:00', 1, 11, ''),
(1, 1001, 16, '10:00:00', 1, 13, '');
...
(7, 'blah', 'blah', 'blah', 99, 'riddhinisar11@gmail.com', '4838ab97756f4794a7d1559b6df482e4', 0);
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
