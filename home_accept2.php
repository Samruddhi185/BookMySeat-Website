...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
  ...
  <?php if (isset($_SESSION['Name'])): ?>
   <a href="home_accept2.php?logout='1'" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    <i class="fa fa-envelope w3-xxlarge"></i>
    <p>LOG OUT</p>
    </a>
  <?php endif ?>
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <?php if (isset($_SESSION['Name'])): ?>
    <a href="home_accept2.php?logout='1'" class="w3-bar-item w3-button" style="width:25% !important">LOG OUT</a>
    <?php endif ?>
  </div>
</div>
...
<div class="w3-padding-large" id="main">
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
    ...
    <form action="server4.php" method="POST">
      ...
      <select class="w3-input w3-padding-16" id="trainnos" required name="trainnos">
           <option value="1">1001</option>
           </select></p>
      <p><label for="stations">Station where you are accepting the seat:<br></label>
      ...
      <p>
        <button class="w3-button w3-light-grey w3-padding-large" type="submit" name="submit4">
